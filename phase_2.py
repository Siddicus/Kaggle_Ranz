...
def Rinz_Model(model, criterion, optimizer, num_epochs=30):
    for i in range(num_epochs):
        ...
        print(i)
        if i == 29:
            torch.save(model.state_dict(), 'Phase2_30_624_thick2.pth')
...
for p in my_model.fc.parameters():
    p.requires_grad = False
teacher_path = r'../input/neptune-teacher-1515epoc/Teacher_1515epoch.pth'
